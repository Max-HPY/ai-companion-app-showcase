...
- Developed responsive frontend features using React Native  
- Integrated frontend components with backend services to enable real-time interactions  
- Applied Git-based workflows (branching, pull requests) to support team collaboration  
...
- Backend: API layer handling user data and interactions  
